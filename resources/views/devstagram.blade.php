...
<div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
  ...
  <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
    <p class="uppercase tracking-loose w-full">Acaso quieres ser programador?</p>
    <h1 class="my-4 text-5xl font-bold leading-tight">
      El camino de la programación tan cerca de ti!
    </h1>
    <p class="leading-normal text-2xl mb-8">
      "Destaca como programador con nuestra aplicación de fotos especializada. Muestra tu talento y conecta con otros profesionales de la programación."
    </p>
    <button  class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
      <a href="/crear-cuenta">Ingresar</a>
    </button>
  </div>
  <!--Right Col-->
  <div class="w-full md:w-3/5 py-6 text-center">
    <img class="w-full md:w-4/5 z-50" src="{{asset('img/iti.png')}}" />
  </div>
</div>
@endsection

@section('svg-finalidad')
<svg class="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="m172 133.75h268v434h-247.58a20.42 20.42 0 0 1 -20.42 -20.42v-413.58z" fill="#0093E9 " />
  ...
  <circle cx="193" cy="127.75" r="6" fill="#0093E9 " />
  <circle cx="208" cy="127.75" r="6" fill="#0093E9 " />
  <circle cx="223" cy="127.75" r="6" fill="#0093E9 " />
